...
import type { ProductResponse, SpiceLevel } from "@/types/product.types";
...
type Props = {
  defaultValue: Partial<ProductFormFields>;
  ...
  const onSubmit = useCallback<SubmitHandler<ProductFormFields>>(
    async (formData) => {
      ...
      try {
        const apiCall =
          action === "edit"
            ? productApiService.updateProduct(formData as any, id!)
            : productApiService.createProduct(formData as any);
  ...
  return (
    <>
      ...
      >
        ...
        <Container title="Basic Details">
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input
                placeholder="Enter description which provides information of the product"
                // rows={3}
              ...
              >
                ...
                <div className="mb-4 grid grid-cols-2 gap-4">
                  <Input
                    ...
                    error={errors.variantGroups?.[groupIndex]?.label?.message}
                  />
                ...
                <Controller
                  name={`variantGroups.${groupIndex}.variants`}
                  control={control}
                  render={({ field }) => (
                    <div className="space-y-2">
                      <label className="text-nl-700 dark:text-nd-200 block text-sm font-medium">
                        Variants
                      </label>
                      {field.value?.map((variant, variantIndex) => (
                        <div
                          key={variantIndex}
                        ...
                        >
                          <Input
                            ...
                            onChange={(e) => {
                              ...
                              newVariants[variantIndex].label = e.target.value;
        ...
        {/* Additional Details */}
        <Container title="Additional Details">
          <div className="space-y-4">
            {/* Tags */}
            <div>
              <label className="text-nl-700 dark:text-nd-200 mb-2 block text-sm font-medium">
        ...
        {/* Nutritional Info */}
        <Container title="Nutritional Info">
