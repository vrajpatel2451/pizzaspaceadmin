...
const OrdersChart: FC<OrdersChartProps> = ({ data, isLoading }) => {
  ...
  return (
    <ChartCard title="Order Activity" subtitle="Orders over time by store" isLoading={isLoading}>
      {hasData ? (
        ...
        <EmptyChartState message="No order data available for the selected time range" />
      )}
    </ChartCard>
  );
};
